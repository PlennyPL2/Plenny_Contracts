...
/// @title PlennyLiqStaking
/// (PlennyLiqMining in BETA release.)
/// @notice This liquidity staking contract allows LPs (a.k.a. “Plenny Whaler”) to stake LP-token (i.e. SLP-PL2)
...
contract PlennyLiqStaking is PlennyBasePausableV2, PlennyLiqMiningStorage {
